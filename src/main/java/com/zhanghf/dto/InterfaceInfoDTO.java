...
public class InterfaceInfoDTO {
    ...
    public String toString() {
        return "InterfaceInfoDTO{REQUEST_TIMEOUT_CONFIG='" + REQUEST_TIMEOUT_CONFIG + "',LOCALHOST_EXTERNAL_SHARING_PLATFORM_URL='" + LOCALHOST_EXTERNAL_SHARING_PLATFORM_URL + "',FEATURE_EXTERNAL_SHARING_PLATFORM_URL='" + FEATURE_EXTERNAL_SHARING_PLATFORM_URL + "',RELEASE_EXTERNAL_SHARING_PLATFORM_URL='" + RELEASE_EXTERNAL_SHARING_PLATFORM_URL + "',MASTER_EXTERNAL_SHARING_PLATFORM_URL='" + MASTER_EXTERNAL_SHARING_PLATFORM_URL + '\'' + '}';
    }
}
